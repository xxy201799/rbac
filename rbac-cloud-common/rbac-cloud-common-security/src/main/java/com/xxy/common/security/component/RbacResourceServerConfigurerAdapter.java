 ...
 */
@Slf4j
public class RbacResourceServerConfigurerAdapter extends ResourceServerConfigurerAdapter {
	@Autowired
	...
	public void configure(ResourceServerSecurityConfigurer resources) {
		...
		UserAuthenticationConverter userTokenConverter = new RbacUserAuthenticationConverter();
