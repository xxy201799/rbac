...
import com.xxy.common.core.exception.RbacDeniedException;
...
@Component
@AllArgsConstructor
public class RbacAccessDeniedHandler extends OAuth2AccessDeniedHandler {
	...
	public void handle(HttpServletRequest request, HttpServletResponse response, AccessDeniedException authException) {
		...
		R<RbacDeniedException> result = R.failed(new RbacDeniedException("授权失败，禁止访问"));
