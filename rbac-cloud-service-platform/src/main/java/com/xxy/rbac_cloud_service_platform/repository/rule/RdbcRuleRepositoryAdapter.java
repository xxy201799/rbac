 ...
 * @author leyou
 */
public abstract class RdbcRuleRepositoryAdapter<T extends RuleEntity> implements RuleRepository<T, Long> {
    @PersistenceContext
    ...
    protected abstract void putRule(T processedEntity);
